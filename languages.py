...
language_packs = {
    "en": {
        ...
        # Team management
        'team_tenant_id_required': 'Tenant ID is required to create a team',
        'team_name_required': 'Team name is required',
        'team_account_required': 'Administrator account is required',
        'team_password_required': 'Administrator password is required',
        'team_account_exists': 'Account already exists, cannot create duplicate account',
        'team_config_invalid': 'Team configuration must be valid JSON',
        ...
        'team_tenant_mismatch': 'No permission to operate this team',
        'team_status_updated_success': 'Team status updated successfully',
        'team_status_update_failed': 'Failed to update team status',
        'team_invalid_status': 'Invalid team status, must be 1 (normal), 2 (disabled) or 3 (deleted)',
        ...
        'scheduled_task_input_required': 'Workflow input parameters not set',
    ...
    "zh": {
        ...
        # Team management
        'team_tenant_id_required': '创建团队需要租户ID',
        'team_name_required': '团队名称不能为空',
        'team_account_required': '管理员账号不能为空',
        'team_password_required': '管理员密码不能为空',
        'team_account_exists': '该账号已存在，无法创建重复账号',
        'team_config_invalid': '团队配置必须是有效的JSON格式',
        'team_create_success': '团队创建成功',
        'team_create_failed': '创建团队失败',
        'team_update_success': '团队更新成功',
        'team_update_failed': '更新团队失败',
        'team_not_found': '团队不存在',
        'team_tenant_mismatch': '无权操作该团队',
        'team_status_updated_success': '团队状态更新成功',
        'team_status_update_failed': '更新团队状态失败',
        'team_invalid_status': '无效的团队状态，必须是1（正常）、2（禁用）或3（删除）',
        ...
        'scheduled_task_input_required': '未设置工作流输入参数',
