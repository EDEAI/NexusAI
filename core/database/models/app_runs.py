...
class AppRuns(MySQL):
    ...
    def set_chatroom_message_id(self, app_run_id: int, chatroom_message_id: int):
        """
        Set the chatroom message ID for an app run.

        :param app_run_id: The app run ID to update
