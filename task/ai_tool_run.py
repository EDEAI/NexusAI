...
agents = Agents()
single_or_multiple = False  # Batch generation switch   True: Multiple agent generation, False: Single agent generation
                ...
                try:
                    ...
                    if result['status'] == 'success':
                        ...
                        if run_ai_tool_type == 2:
                            value_str = result['data']['outputs']['value']
                            result['data']['outputs']['value'] = json.loads(value_str)
                            ...
                            result['data']['outputs']['value']['input_variables'] = test_var_obj.to_dict()
                            ...
                            result['data']['outputs']['value']['output_variables'] = output_variables_value_obj.to_dict()
                            result['data']['outputs']['value'] = json.dumps(result['data']['outputs']['value'], ensure_ascii=False)
                        ...
                        if run_ai_tool_type == 1 and ai_tool_type == 'generate_agent_batch':
                            ...
                            if single_or_multiple:
                                ...
                                if loop_count > 0:
                                    ...
                                    # ai_tool_llm_records.initialize_execution_record(app_run_id, run_ai_tool_type, 4, loop_id, loop_limit, loop_count, inputs_new, single_or_multiple)
