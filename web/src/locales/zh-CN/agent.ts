...
export default {
    ...
    'agent.optimize.button': 'AI优化',
    'agent.optimize.modal.title': 'AI优化智能体',
    'agent.optimize.modal.desc':
        'AI将根据你的优化建议，针对智能体的名称、描述、职能与能力进行调整，其他配置不会被修改。请描述你希望优化的方向或重点。',
    'agent.optimize.modal.placeholder': '请输入你的优化思路，例如强化目标用户、优化能力描述或补充关键职责……',
    'agent.optimize.submit': '提交优化',
    'agent.optimize.cancel': '取消',
    'agent.optimize.apply': '应用优化',
    'agent.optimize.continue': '继续优化',
    'agent.optimize.error.noData': '当前没有可用于优化的智能体数据',
    'agent.optimize.error.failed': 'AI优化请求失败，请稍后重试',
    'agent.optimize.error.invalid': 'AI返回的数据无法解析，请重新尝试',
    'agent.optimize.error.required': '请输入优化意见',
    'agent.optimize.apply.success': '已应用AI优化结果',
    'agent.optimize.diff.title': 'AI优化对比',
    'agent.optimize.diff.current': '当前设置',
    'agent.optimize.diff.optimized': 'AI建议',
    'agent.optimize.diff.abilities': '能力对比',
    'agent.optimize.diff.removed': '已移除',
    'agent.optimize.diff.added': '新增',
    'agent.optimize.diff.ability.id': '能力ID',
    'agent.optimize.diff.ability.new': '新增能力',
    'agent.optimize.diff.output.default': '默认',
    'agent.optimize.diff.output.text': '文本',
    'agent.optimize.diff.output.json': 'JSON',
    'agent.optimize.diff.output.code': '代码',
    'agent.optimize.diff.confirm.title': '确认关闭AI优化结果？',
    'agent.optimize.diff.confirm.content': '关闭后当前的AI优化结果将不会保留，若需再次查看需重新发起优化，请确认是否继续关闭。',
    'agent.optimize.diff.confirm.ok': '仍要关闭',
    'agent.optimize.diff.confirm.cancel': '留在此处',
