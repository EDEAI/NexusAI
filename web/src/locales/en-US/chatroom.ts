export default {
    ...
    // MCP Tool Display - Types
    'app.chatroom.mcptool.type.skill': 'Skill',
    'app.chatroom.mcptool.type.workflow': 'Workflow',
    'app.chatroom.mcptool.type.tool': 'Tool',
    
    // MCP Tool Display - UI Labels
    'app.chatroom.mcptool.toolCalls': 'Tool Calls',
    'app.chatroom.mcptool.inputVariables': 'Input Variables',
    'app.chatroom.mcptool.otherParameters': 'Other Parameters',
    'app.chatroom.mcptool.noParameters': 'No parameters available',
  ...
  'app.chatroom.mcptool.inputFiles': 'Input Files',
    ...
    'app.chatroom.mcptool.confirmer': 'Confirmer',
    'app.chatroom.mcptool.status': 'Status',
    'app.chatroom.mcptool.appRunId': 'App Run ID',
    'app.chatroom.mcptool.nodeExecId': 'Node Exec ID',
    'app.chatroom.mcptool.requiresConfirmation': 'Requires User Confirmation',
