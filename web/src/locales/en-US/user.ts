...
export default {
    ...
    'user.positionRequired': 'Please enter job title',
    ...
    "register.position": "Job Title",
    "register.position.tooltip": "Your job title in the company or team, such as: Product Manager, Software Engineer, Designer, etc.",
    "register.position.required": "Please enter your job title",
