...
export default {
    ...
    // Schedule execution related
    'workflow.scheduleExecution': 'Schedule Execution',
    'workflow.viewSchedulePlan': 'View Schedule Plan',
    'workflow.scheduleType': 'Schedule Type',
    'workflow.singleRun': 'Single Run',
    'workflow.repeatRun': 'Repeat Run',
    'workflow.startTime': 'Start Time',
    'workflow.repeatDimension': 'Repeat Frequency',
    'workflow.repeatInterval': 'Repeat Interval',
    'workflow.endCondition': 'End Condition',
    'workflow.noEnd': 'No End',
    'workflow.setEndTime': 'Set End Time',
    'workflow.endTime': 'End Time',
    'workflow.confirmExecution': 'Confirm Execution',
    'workflow.schedule.savePlan': 'Save Plan',
    'workflow.cancelSchedule': 'Cancel Schedule',
    'workflow.message.scheduleFailure': 'Failed to create schedule',
    'workflow.minute': 'Minute',
    'workflow.hour': 'Hour',
    'workflow.day': 'Day',
    'workflow.week': 'Week',
    'workflow.month': 'Month',
    'workflow.year': 'Year',
    'workflow.scheduleExecutionTitle': 'Schedule Execution Settings',
    'workflow.pleaseSelectStartTime': 'Please select start time',
    'workflow.pleaseInputInterval': 'Please input repeat interval',
    'workflow.pleaseSelectEndTime': 'Please select end time',
    'workflow.intervalMustBePositive': 'Repeat interval must be a positive integer',
