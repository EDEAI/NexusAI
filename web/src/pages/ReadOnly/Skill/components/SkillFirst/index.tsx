            ...
            >
                ...
                <div className="mb-[15px] text-xs font-bold flex justify-between items-center">
                    <div className="text-[#555555] text-xs font-medium">
                        <Callword
                            ...
                            title={intl.formatMessage({ id: 'skill.Callword.inputvariable' })}
                        />
                    </div>
                </div>
                ...
                <div>
                    {FirstSkillref &&
                        ...
                        FirstSkillref.getFieldValue().users.map((item: any, index: number) => {
                            return (
                                <div
                                ...
                                >
                                    ...
                                    <Form.Item className="w-12 mr-14 m-0">
                                        <Switch {...disabled} size="small" checked={item.status} />
                                    </Form.Item>
                                </div>
                            );
                        })}
