...
const AgentsFourthly: React.FC<ChildProps> = ({
    ...
    const AgentPublish = async () => {
        const res = await PutagentPublish(Detaillist.agent.agent_id);
        if (res.code == 0) {
        ...
        <div style={{ height: '100%' }}>
            ...
            <div>
                ...
                >
                    ...
                    <Form.Item>
                        <div className="w-28">
                            {Detaillist?.agent.publish_status === 1 &&
                            Detaillist?.is_creator === 1 ? (
                                <div>
                                    <Button
                                        type="primary"
                                        htmlType="submit"
